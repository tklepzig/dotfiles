...
Additional Software (run as non-privileged user)
    ...
    sudo pacman -S dmenu i3-dmenu-desktop rofi i3blocks i3lock i3status i3-wm brightnessctl dex network-manager-applet xss-lock feh playerctl dunst blueman
